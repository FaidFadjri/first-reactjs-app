...
import { BusinessImg } from '../../assets';
    ...
    <div className='main-page'>
      <div className='left'>
        <div className='content'>
          <img src={BusinessImg} alt='illustrasi' className='illustrasi'/>
      ...
      <div className='right'>
        ...
        <form>
          ...
          <Gap height={10}/>
          <Input label="Konfirmasi Password" placeholder="Konfirmasi Password Anda" name="confPassword" autocompletes='off'/>
          <Gap height={20}/>
